...
global.owner = ['+966559851244']
global.ownertag = '+966559851244' //your tag number
global.botname = '𝙰𝙽𝚇𝙰𝙸-𝙱𝙾𝚃' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "𝙰𝙽𝚇𝙰𝙸" // sticker author
global.dragonemoji = '🤖' // Menu emoji
global.footer = '[ ◉ 𝙰𝙽𝚇𝙰𝙸-𝙼𝙳 ]' //

//database
global.premium = ['+966559851244'] //ur premium numbers
...
global.mess = {
    success: 'Done ✅',
    admin: 'فقط المشرفين يمكنهم استخدام هذا',
    botAdmin: 'يرجى إعطاء إشراف للبوت',
    owner: 'فقط المالك يمكنه استخدام هذا الامر',
    group: 'هذا الأمر للمجموعات فقط',
    private: 'هذا الأمر للخاص فقط',
    bot: 'هذا الأمر للبوت فقط',
    wait: 'انتظر لحظة... ',
    error: 'خطأ !!! ربما المفتاح معطل',
    endLimit: 'حدك اليومي قد انتهى، الحد سيعاد كل 12 ساعة ',
    linkm: 'وين الرابط؟ ',
    nsfw: 'هذا الأمر لم يتم تفعيله بعد، يرجى التواصل مع المشرفين لتشغيله',
    banChat: 'هذا البوت محظور في هذا الشات، يرجى التواصل مع المالك لرفع الحظر ',
    badwords: 'الكلمات السيئة غير مسموحة هنا',
    spam: 'تم رصد سبام',
    caption: 'Generated by: ◉ *𝙰𝙽𝚇𝙰𝙸-𝙱𝙾𝚃*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 1000000,
